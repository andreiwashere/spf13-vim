...
```bash
    ...
    curl https://raw.githubusercontent.com/andreiwashere/spf13-vim/3.0/bootstrap.sh -L > spf13-vim.sh && sh spf13-vim.sh
```

If you have a bash-compatible shell you can run the script directly:
```bash

    sh <(curl https://raw.githubusercontent.com/andreiwashere/spf13-vim/3.0/bootstrap.sh -L)
```

## Installing on Windows

Please use the upstream [spf13-vim/spf13-vim](https://github.com/spf13-vim/spf13-vim) package.
